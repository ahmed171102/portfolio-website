...
export default function Hero() {
  return (
    ...
    >
      <div
        className="bg-blob animate-float -top-20 -left-20 h-72 w-72 bg-accent"
        aria-hidden="true"
      />
      <div
        className="bg-blob animate-float top-10 -right-24 h-80 w-80 bg-purple-400"
      ...
      <Reveal delay={80}>
        <h1 className="max-w-3xl text-4xl font-semibold tracking-tight sm:text-5xl">
          ...
          <span className="text-gradient"> machine learning systems</span>,
      ...
      <Reveal delay={240}>
        <div className="mt-8 flex flex-wrap items-center gap-4">
          <a
            href="#projects"
            className="inline-flex items-center gap-2 rounded-full bg-foreground px-5 py-2.5 text-sm font-medium text-background transition hover:scale-105 hover:opacity-90"
          >
            View projects
          ...
          <a
            href="/resume.pdf"
            className="inline-flex items-center gap-2 rounded-full border border-black/10 px-5 py-2.5 text-sm font-medium transition hover:scale-105 hover:border-black/25 dark:border-white/15 dark:hover:border-white/30"
          >
            Download résumé
          </a>
        </div>
