        ...
        {filtered.map((p, i) => (
          <Reveal key={p.slug} delay={(i % 4) * 90}>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-black/10 p-6 transition duration-300 hover:-translate-y-1 hover:border-black/25 hover:shadow-lg dark:border-white/10 dark:hover:border-white/25"
            >
              <span
